...
public class MathUtils {
    ...
    protected static final double[] a = new double[65536];
    ...
    public static float normalizeValue(float p, float valueMin, float valueMax, float valueStep) {
        return MathHelper.clamp_float((snapToStepClamp(p, valueMin, valueMax, valueStep) - valueMin) / (valueMax - valueMin), 0.0F, 1.0F);
    }
